...
```
[root@localhost ]# wget https://codeload.github.com/ossrs/srs/zip/refs/heads/4.0release
[root@localhost ]# cd /usr/local/src/srs-4.0release/trunk
[root@localhost ]# ./configure 
[root@localhost ]# make && make install
[root@localhost ]# 
[root@localhost ]# 
# 开机
[root@localhost ]# ./objs/srs -c conf/srs.conf
[root@localhost ]# ./etc/init.d/srs status
    Error: Process 49353 does not exists    [FAILED]
