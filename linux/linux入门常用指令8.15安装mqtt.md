...
```
#查看是否已安装过
[root@localhost ]# [root@localhost src]# rpm -qa|grep emqx
emqx-4.2.14-1.el8.x86_64
[root@localhost ]# [root@localhost src]# rpm -e emqx-4.2.14-1.el8.x86_64

# 一定要选择与操作系统对应的版本
[root@localhost ]# wget https://www.emqx.com/zh/downloads/broker/4.2.14/emqx-centos7-4.2.14-x86_64.rpm
[root@localhost ]# yum install emqx-centos7-4.2.14-x86_64.rpm
