...
```
数仓架构发展史
https://www.ikeguang.com/?p=1582
https://www.ikeguang.com/?p=1559

https://www.ikeguang.com/?p=1582
数仓建模—指标体系
https://www.ikeguang.com/?p=1957
```

https://cloud.baidu.com/doc/TSDB/index.html
...
@RequestHeader:rc.request.getHeader("");
@RequestParam: rc.request.getParam();
@RequestBody: rc.getBody();
@PathVariable: rc.pathParam("")
```


监测更安全，进度可管控，质量有保障，数据可追溯，
